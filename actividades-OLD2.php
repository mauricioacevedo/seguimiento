...
function isNumber(n) {
  return !isNaN(parseFloat(n)) && isFinite(n);
	...
	function guardarDatos(){
		...
		var request='&pedido='+pedido+'&id_tecnico='+id_tecnico+'&nombre_de_la_empresa='+nombre_de_la_empresa+'&login_del_asesor='+login_del_asesor+'&accion='+accion+'&tipo_pendiente='+tipo_pendiente+"&proceso="+proceso+"&producto="+producto+"&duracion="+duracion+'&llamada_id='+llamada_id+'&fecha='+fecha+'&observaciones='+observaciones;
...
<CENTER><H2>Rastro de aquellos pedidos pendientes o cumplidos simultaneamente</H2></CENTER>
...
<TR>
	...
	<TD align="center">
	<div id="divIngreso"><INPUT type="button" name="buscar" id="buscar" value="Buscar" onclick="javascript:buscarTecnico();"></div>
	</TD>
</TR>
<TR>
...
<div id="question" style="display:none; cursor: default">
        ...
        <input type="button" id="yes" value="Iniciar Llamada" />
        <INPUT type="button" value="Ver Registros" onclick="javascript:formaRegistros();">
