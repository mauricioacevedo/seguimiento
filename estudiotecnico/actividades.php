	...
	function selectProceso(){
		...
		if(procesoValue=="Asignaciones"){
			...
			accion.length=0;
                        ...
                        var banner=document.getElementById("bannercentral");
                        banner.innerHTML="<IMG src='./img/logo-estudio2.png' height='111' width='90%'>";
...
<TR>
        ...
        <TD align="center">
			...
			<option value="GPON">GPON-Internet</option>
			<option value="GPON">GPON-IPTV</option>
			<option value="GPON">GPON-ToIP</option>
                </SELECT>
        </TD>
        <TD align="center"></TD>
</TR>
